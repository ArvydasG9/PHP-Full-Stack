...
console.log(k2);
console.log(k3);
if (Math.max(k2, k3) > k1 && Math.min(k2, k3) < k1) console.log(k1);
else if (Math.max(k1, k3) > k2 && Math.min(k1, k3) < k2) console.log(k2);
else if (Math.max(k1, k2) > k3 && Math.min(k1, k2) < k3) console.log(k3);
// ----   3  --------------
